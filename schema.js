module.exports = function () {
    schema = {
         siteName: '', // A commonly recognized name for the food distribution site. // Done
         siteStatus: '', // Status of the food distribution site, one of​ Open​ or C​losed. // Done
         siteAddress: '', // 1234 example street, San Diego, CA 90210 // Done
         siteState: '', // CA // Done
         siteZip: '', // i don't know why we need this if we have lat/lng - Max // Done
        ...
        endDate: '', // Date the site closes in the format ​mm/dd/yy.
         daysofOperation: '', // Days of the week the site operates. This is a comma-separated list of week day abbreviations i.e. ​M,T,W,Th,F,Sa,S. // Done
        ...
        _geoloc: { // Site latitude and longitude in the WGS84/4326 coordinate system. //Done
        lat: '',
        lng: ''
        },
